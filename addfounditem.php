...
<body>
<div class="regform"><h1>Add Found Item</h1></div>
<div class="main">
...
<div id="name">
    ...
    <input type="text"class="firstname" name="date_loss" placeholder="date_found" id="firstname" required> <br>
<label class="firstlabel">Date Found</label>
<input type="text" class="lastname" name="time_loss" placeholder="time_found" id="lastname" required> 
...
<div id="name">
    ...
    <input type="text" class="firstname" name="item_category" placeholder="item_category" id="username" required>  <br>
<label class="firstlabel">Item Category</label>
<input type="text" class="lastname" name="item_name" placeholder="item_name" id="password" required>
<label class="lastlabel">Item Name</label>
</div>


<h2 class="name">Item Brand</h2>
<input type="text" class="email" name="item_brand" placeholder="item_brand" id="Email" required>
<h2 class="name">Add Descrition</h2>
<input type="text" class="email" name="add_descrition" placeholder="add_descrition" id="Email" required>
...
<h2 class="name">Photo</h2>
    ...
    <img src="upload/approve_image.jpg" onclick="triggerClick()" id="profileDisplay" width="150"; hieght="150px"; ><br>

<button type="submit" class="sub-btn" name ="Signup" value="submit form"> FINISH</button>
<div class ="container">
 <button type="" class="sub-btn" onclick="window.location.replace('managefounditem.php');">CANCEL</button>
 </div>   
 </form>
