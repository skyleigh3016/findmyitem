...
<input type="text" class="email" name="status" placeholder="<?php echo $row['status'];?>" value="<?php echo $row['status'];?>" id="Email" required>
<h2 class="name">Remarks</h2>
<input type="text" class="email" name="remark" placeholder="Done Comment" value="Done Comment" id="Email" required>
<h2 class="name">Message</h2>
<input type="text" class="email" name="message" placeholder="Please Write a message" id="Email" required>
...
<div class ="container">
 <button type="" class="sub-btn" onclick="window.location.replace('home1.php');">CANCEL</button>
 </div>   
 </form>
