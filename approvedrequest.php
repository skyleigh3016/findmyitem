...
<body>
<div class="regform"><h1>For Approval Form</h1></div>
<div class="main">
...
<select class="option" name="remark" id="access" required>
    <option disable="disable" selected ="selected">--choose option</option>
    <option value="Please give regards to the finder or give feedback to our system to claimed the item">Please give regards to the finder or give feedback to our system to claimed the item</option>
...
<button type="submit" class="sub-btn" name ="cancel" value="submit form"><a href="manageverified.php">CANCEL</a></button> 
 </form>
