...
<body>
<div class="regform"><h1>Found Item Information Form</h1></div>
<div class="main">
...
<div id="name">
    ...
    <input type="text"class="firstname" name="date_loss" placeholder="Date Found" id="firstname" required> <br>
<label class="firstlabel">Date Found</label>
<input type="text" class="lastname" name="time_loss" placeholder="Time Found" id="lastname" required> 
