...
<td>
<a href="request.php?ID=<?php echo $row['found_id'];?>" class="edit" id ="btnEditmodal" name="btnEditmodal" 
data-toggle="modal"
>  <div class="btn-group">
...
<a href = "home1.php" class="btn btn-success btn-lg" data-toggle ="modal"><span>Back</span></a>
</div>
