...
<a href = "addaccount.php" class="btn btn-success btn-lg" data-toggle ="modal"><span>Add User Account</span></a>
<a href="report.php" class="btn btn-primary btn-lg"><span>Print Report</span></a>
</div>
<div class="container">
...
<td><img src="upload/<?php echo $row['userimage']; ?>" width="80" ></td>
...
<td>
<a href="deleteaccount.php?ID=<?php echo $row['id'];?>" class="edit" id ="btnEditmodal" name="btnEditmodal" 
data-toggle="modal"
>  <i class="fa fa-trash" style='font-size:12px;color:black' data-toggle="toolkit" 
title="Delete"></i></a>
<a href="details.php?ID=<?php echo $row['id'];?>" class="edit" id ="btnEditmodal" name="btnEditmodal" 
data-toggle="modal"
