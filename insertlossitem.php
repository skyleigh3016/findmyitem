...
<body>
<div class="regform"><h1>Loss Item Information Form</h1></div>
<div class="main">
...
<div id="name">
    ...
    <input type="text"class="firstname" name="date_loss" placeholder="Date Loss" id="firstname" required> <br>
<label class="firstlabel">Date Loss</label>
<input type="text" class="lastname" name="time_loss" placeholder="Time Loss" id="lastname" required> 
...
<select class="option" name="place_item_loss" id="access" required>
    ...
    <option value="building F room 2">building F room 2</option>
    <option value="building D room 3">building D room 3</option>
</select>
<div id="name">
...
<select class="option" name="status" id="access" required>
    <option disable="disable" selected ="selected">--Choose Option</option>
    <option value="Loss Item">Loss Item</option>
    <option value="Return Found Item">Found Item</option>
</select>
...
<div class ="container">
 <button onclick="history.back()" class="sub-btn">CANCEL</button>
 </div>   
 </form>
