...
<a href="printfounditem.php" class="btn btn-primary btn-lg"><span>Print all Report</span></a>
</div>
<div class="container">
...
<td>
<a href="deletefound.php?ID=<?php echo $row['found_id'];?>" class="edit" id ="btnEditmodal" name="btnEditmodal" 
data-toggle="modal"
>  <i class="fa fa-print" style='font-size:12px;color:black' data-toggle="toolkit" 
title="Delete"></i></a>
<a href="editfound.php?ID=<?php echo $row['found_id'];?>" class="edit" id ="btnEditmodal" name="btnEditmodal" 
data-toggle="modal"
