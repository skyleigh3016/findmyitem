...
$sql="SELECT * FROM `claim_item` WHERE status = 'On Going Proccess'";
...
<div class = "row">
<div class = "col-sm-6">
<h2><b>Ongoing Proccess Request to Claim Item</b></h2>
</div>
</div>
</div>
...
<td class="firstname"><?php echo $row['date_requested'];?></td>
<td class="lastname"><?php echo $row['time_requested'];?></td>
...
<td class="gender"><?php echo $row['description_claimed'];?></td>
...
<button onclick="history.back()" class="btn btn-success btn-lg" data-toggle ="modal"><span>Back</span></button>
</div>
