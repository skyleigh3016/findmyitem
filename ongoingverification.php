...
<body>
<div class="regform"><h1>For Verification Form</h1></div>
<div class="main">
...
<label class="firstlabel">Verified Date</label>
<input type="text" class="lastname" name="time" placeholder="<?php echo $time1;?>" id="lastname"
value="<?php echo $time1;?>" > 
<label class="lastlabel">Verified Time</label>
</div>
<h2 class="name">Verified By</h2>
...
<select class="option" name="status" id="access" required>
    ...
    <option value="On Going Verification">On Going Verification</option>
    <option value="Dis Approved Request">Dis Approved Request</option>
</select>
<h2 class="name">Remarks</h2>
<select class="option" name="remark" id="access" required>
    <option disable="disable" selected ="selected">--choose option</option>
    <option value="Please go to Loss and Found station for face to face Verification">Please go to Loss and Found station for face to face Verification</option>
    <option value="Not same Item">Not same Item</option>
</select>
...
<button type="submit" class="sub-btn" name ="cancel" value="submit form"><a href="manageongoing.php">CANCEL</a></button> 
 </form>
