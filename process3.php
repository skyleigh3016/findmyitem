...
if(isset($_POST['Signup']))
{
    ...
    {
        $sql="INSERT INTO `loss_item`(`user_id`, `date`, `time`,`photo`,`date_loss`, `time_loss`,`place_loss`,`item_category`,`item_name`,`item_brand`,`add_description`,`status`) 
        ...
        if(mysqli_query($conn,$sql))
        {
            ...
            echo header("location: founditem.php");
