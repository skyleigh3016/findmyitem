...
<p style ="color:aliceblue;font-size:20px;">Note: Please provide a student id or any valid id for approval.</p>
<button onclick="popUp()" type="submit" class="sub-btn" name ="Signup" value="submit form"> Register </button>
<div class ="container">
 <button type="" class="sub-btn" onclick="window.location.replace('login.php');">   Cancel   </button>
 </div>   
 </form>
