...
$sql="SELECT * FROM `claim_item` WHERE status = 'On Going Verification'";
...
<div class = "row">
<div class = "col-sm-6">
<h2><b>For Verification of Request to Claim Item</b></h2>
</div>
</div>
</div>
...
<td class="password"><?php echo $row['date_verified'];?></td>
